...
Ensure you've opened your project in folder view to see all it's components. In BAS this can be done via Explorer (Ctrl-Shft-E) and Open Folder. Open the folder ``/home/user/caprisks/db/``. 
