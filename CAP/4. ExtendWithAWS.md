...
As you can see a type does not need a `key` field, and this one uses a nested object to represent the `Owner` of the file. Because we need to return it as an array from our function:
